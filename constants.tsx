...
/** Versão de 600px para a fita e o fundo. A resolução cheia fica no modal. */
const THUMB = (slug: string) => `/assets/flash/thumbs/${slug}.jpg`;
