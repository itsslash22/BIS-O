    ...
    <section className="relative h-screen w-full flex items-center overflow-hidden bg-black select-none">
      ...
      >
        <img
          ...
          width={2000}
          height={1333}
          style={({ fetchPriority: 'high', objectPosition: isMobile ? 'center' : 'right' } as any)}
          className="w-full h-full object-cover grayscale brightness-[0.45] contrast-150 scale-125 md:scale-115 origin-right"
        />
        {/* Artistic Overlays */}
